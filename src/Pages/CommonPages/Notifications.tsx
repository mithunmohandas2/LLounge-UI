    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center mt-5 h-screen">
                <div className="bg-gray-100 p-10 px-14 rounded-lg shadow-lg">
                    <h1 className="text-3xl font-bold mb-4">Notifications</h1>
                    <div className="space-y-4">
                        {notifications.length ? notifications.map((note) => (
                            <div key={note._id} className="flex items-start">
                                ...
                                <div className="ml-4">
                                    <p className="text-gray-800 font-bold">{note.message}</p>
                                    <p className="text-gray-600">{format(note.createdAt, 'MMMM dd, yyyy - h:mm:ss a')}</p>
                                </div>
